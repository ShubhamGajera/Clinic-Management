...
{
    public partial class Laboratory_Page : Form
    {
        public Laboratory_Page()
        {
            InitializeComponent();
        }
        ...
        private void Receptionists_page_pic_Click_1(object sender, EventArgs e)
        {
        ...
        private void Receptionists_page_Click_1(object sender, EventArgs e)
        {
            Receptionists_Page ReceptionistsPage = new Receptionists_Page();
            ReceptionistsPage.Show();
            this.Hide();
